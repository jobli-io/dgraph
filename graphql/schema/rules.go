...
func init() {
	...
	validator.AddRuleWithOrder("Check memberTypes not nested in and/or/not", baseRules, memberTypesCheck)
	validator.AddRuleWithOrder("Check groupBy query arguments", baseRules, groupByArgumentsCheck)
