...
type Starship {
	...
	// GroupByResult types — generated by addGroupByResultType for every type with groupable fields.
	authorGroupByResult := map[string]string{
		"count":         "AuthorGroupByResult.count",
		"dob":           "AuthorGroupByResult.dob",
		"dobMax":        "AuthorGroupByResult.dobMax",
		"dobMin":        "AuthorGroupByResult.dobMin",
		"name":          "AuthorGroupByResult.name",
		"nameMax":       "AuthorGroupByResult.nameMax",
		"nameMin":       "AuthorGroupByResult.nameMin",
		"reputation":    "AuthorGroupByResult.reputation",
		"reputationAvg": "AuthorGroupByResult.reputationAvg",
		"reputationMax": "AuthorGroupByResult.reputationMax",
		"reputationMin": "AuthorGroupByResult.reputationMin",
		"reputationSum": "AuthorGroupByResult.reputationSum",
	}
	characterGroupByResult := map[string]string{
		"count":   "CharacterGroupByResult.count",
		"name":    "CharacterGroupByResult.name",
		"nameMax": "CharacterGroupByResult.nameMax",
		"nameMin": "CharacterGroupByResult.nameMin",
	}
	droidGroupByResult := map[string]string{
		"count":              "DroidGroupByResult.count",
		"name":               "DroidGroupByResult.name",
		"nameMax":            "DroidGroupByResult.nameMax",
		"nameMin":            "DroidGroupByResult.nameMin",
		"primaryFunction":    "DroidGroupByResult.primaryFunction",
		"primaryFunctionMax": "DroidGroupByResult.primaryFunctionMax",
		"primaryFunctionMin": "DroidGroupByResult.primaryFunctionMin",
	}
	employeeGroupByResult := map[string]string{
		"count":    "EmployeeGroupByResult.count",
		"ename":    "EmployeeGroupByResult.ename",
		"enameMax": "EmployeeGroupByResult.enameMax",
		"enameMin": "EmployeeGroupByResult.enameMin",
	}
	humanGroupByResult := map[string]string{
		"count":           "HumanGroupByResult.count",
		"ename":           "HumanGroupByResult.ename",
		"enameMax":        "HumanGroupByResult.enameMax",
		"enameMin":        "HumanGroupByResult.enameMin",
		"name":            "HumanGroupByResult.name",
		"nameMax":         "HumanGroupByResult.nameMax",
		"nameMin":         "HumanGroupByResult.nameMin",
		"totalCredits":    "HumanGroupByResult.totalCredits",
		"totalCreditsAvg": "HumanGroupByResult.totalCreditsAvg",
		"totalCreditsMax": "HumanGroupByResult.totalCreditsMax",
		"totalCreditsMin": "HumanGroupByResult.totalCreditsMin",
		"totalCreditsSum": "HumanGroupByResult.totalCreditsSum",
	}
	postGroupByResult := map[string]string{
		"count":    "PostGroupByResult.count",
		"postType": "PostGroupByResult.postType",
	}
	starshipGroupByResult := map[string]string{
		"count":     "StarshipGroupByResult.count",
		"length":    "StarshipGroupByResult.length",
		"lengthAvg": "StarshipGroupByResult.lengthAvg",
		"lengthMax": "StarshipGroupByResult.lengthMax",
		"lengthMin": "StarshipGroupByResult.lengthMin",
		"lengthSum": "StarshipGroupByResult.lengthSum",
		"name":      "StarshipGroupByResult.name",
		"nameMax":   "StarshipGroupByResult.nameMax",
		"nameMin":   "StarshipGroupByResult.nameMin",
	}
	...
	expected := map[string]map[string]string{
		...
		// GroupByResult types:
		"AuthorGroupByResult":    authorGroupByResult,
		"CharacterGroupByResult": characterGroupByResult,
		"DroidGroupByResult":     droidGroupByResult,
		"EmployeeGroupByResult":  employeeGroupByResult,
		"HumanGroupByResult":     humanGroupByResult,
		"PostGroupByResult":      postGroupByResult,
		"StarshipGroupByResult":  starshipGroupByResult,
	}
...
func TestDgraphMapping_WithDirectives(t *testing.T) {
	...
	// GroupByResult types use their own type name prefix regardless of @dgraph custom preds.
	authorGroupByResult := map[string]string{
		"count":         "AuthorGroupByResult.count",
		"dob":           "AuthorGroupByResult.dob",
		"dobMax":        "AuthorGroupByResult.dobMax",
