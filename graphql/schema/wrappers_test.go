...
type Starship {
	...
	authorGroupByResult := map[string]string{
		...
		"groupKeys":     "AuthorGroupByResult.groupKeys",
	...
	characterGroupByResult := map[string]string{
		...
		"groupKeys": "CharacterGroupByResult.groupKeys",
	...
	droidGroupByResult := map[string]string{
		...
		"groupKeys":          "DroidGroupByResult.groupKeys",
	...
	employeeGroupByResult := map[string]string{
		...
		"groupKeys": "EmployeeGroupByResult.groupKeys",
	...
	humanGroupByResult := map[string]string{
		...
		"groupKeys":       "HumanGroupByResult.groupKeys",
	...
	postGroupByResult := map[string]string{
		...
		"groupKeys": "PostGroupByResult.groupKeys",
	}
	starshipGroupByResult := map[string]string{
		"count":     "StarshipGroupByResult.count",
		"groupKeys": "StarshipGroupByResult.groupKeys",
	...
	expected := map[string]map[string]string{
		...
		"GroupByKeyValue":        {"path": "GroupByKeyValue.path", "value": "GroupByKeyValue.value"},
	}
